...
class landsatData(Data):
    ...
    _products = {
        ...
        'rhow': {
            ...
            'acolite-pattern': '.*_RHOW_[0-9]+.tif',
            'toa': True,
        },
        'rhoam': {
            'assets': ['DN'],
            ...
            'acolite-pattern': '.*_RHOAM_VNIR.tif',
            'toa': True,
        },
        'oc2chl': {
            'assets': ['DN'],
        ...
        'spm665': {
            ...
            'acolite-pattern': '.*_SPM_NECHAD_[0-9]+.tif',
            'toa': True,
        },
        'turbidity': {
            'assets': ['DN'],
            ...
            'acolite-pattern': '.*_T_DOGLIOTTI.tif',
            'toa': True,
        },
    }
